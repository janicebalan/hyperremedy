...
class AuthModel {
	...
	async signin(username, password) {
		...
		if (signInResult && signInResult.localId) await this._grantUserWithAdminRole(signInResult.localId);
	...
	async _grantUserWithAdminRole(uid) {
		...
		if (doc.exists) return this.auth.setCustomUserClaims(uid, { admin: true });
	}
