...
class GraphYear extends StatelessWidget {
    ...
    return View(
        ...
        builder: (_context, _viewmodel, _child) {
          return Column(
            children: [
              Text(
                'Your statistics of BP readings for the last 1 year',
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        Text(
                          'Diastolic:${_viewmodel.avgDiaYear.toStringAsFixed(2)}  Systolic:${_viewmodel.avgSysYear.toStringAsFixed(2)}  Pulse:${_viewmodel.avgPulYear.toStringAsFixed(2)}',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 14.0,
                            fontWeight: FontWeight.bold,
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        Text(
                          'Diastolic:${_viewmodel.maxDiaYear}  Systolic:${_viewmodel.maxSysYear}  Pulse:${_viewmodel.maxPulYear}',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 14.0,
                            fontWeight: FontWeight.bold,
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        Text(
                          'Diastolic:${_viewmodel.minDiaYear}  Systolic:${_viewmodel.minSysYear}  Pulse:${_viewmodel.minPulYear}',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 14.0,
                            fontWeight: FontWeight.bold,
  ...
  LineChartData mainData(ReportViewmodel viewmodel) {
    return LineChartData(
      ...
      lineBarsData: [
        LineChartBarData(
          spots: viewmodel.systolic_arrYear,
          isCurved: true,
          color: Colors.red,
          barWidth: 5,
        ...
        LineChartBarData(
          spots: viewmodel.diastolic_arrYear,
          isCurved: true,
          color: Colors.blue,
          barWidth: 5,
          isStrokeCapRound: true,
